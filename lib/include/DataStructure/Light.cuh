    ...
    class Light
    {
        public:
            ...
            */
            __host__ __device__
            Vector3float
            sample(uint32_t& seed, const Vector3float& position, Vector3float& lightDir, float& distance);
        ...
        private:
            ...
            */
            __host__ __device__
            Vector3float
            sample_point(uint32_t& seed, const Vector3float& position, Vector3float& lightDir, float& distance);
            ...
            */
            __host__ __device__
            Vector3float
            sample_area(uint32_t& seed, const Vector3float& position, Vector3float& lightDir, float& distance);

    };
} //namespace cupbr

#include "../../src/DataStructure/LightDetail.cuh"
